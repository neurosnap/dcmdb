...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Series.series_description'
        db.add_column(u'dcmupload_series', 'series_description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Series.body_part_examined'
        db.add_column(u'dcmupload_series', 'body_part_examined',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Series.series_description'
        db.delete_column(u'dcmupload_series', 'series_description')

        # Deleting field 'Series.body_part_examined'
        db.delete_column(u'dcmupload_series', 'body_part_examined')
