...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Study', fields ['UID']
        db.create_unique(u'dcmupload_study', ['UID'])


    def backwards(self, orm):
        # Removing unique constraint on 'Study', fields ['UID']
        db.delete_unique(u'dcmupload_study', ['UID'])
