...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Image.image_number'
        db.alter_column(u'dcmupload_image', 'image_number', self.gf('django.db.models.fields.IntegerField')(default=0))
    ...
    models = {
        u'dcmupload.image': {
            ...
            'image_number': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
        ...
        u'dcmupload.series': {
            ...
            'series_number': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'})
        },
        u'dcmupload.study': {
