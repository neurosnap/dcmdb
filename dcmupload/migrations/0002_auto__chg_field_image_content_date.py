...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'dcmupload_image', 'content_date', self.gf('django.db.models.fields.DateField')(auto_now=True))

    def backwards(self, orm):

        # Changing field 'Image.content_date'
        db.alter_column(u'dcmupload_image', 'content_date', self.gf('django.db.models.fields.DateField')())

    models = {
        u'dcmupload.image': {
            'Meta': {'object_name': 'Image'},
            'UID': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'content_date': ('django.db.models.fields.DateField', [], {'default': 'None', 'auto_now': 'True', 'blank': 'True'}),
