...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Series', fields ['UID']
        db.create_unique(u'dcmupload_series', ['UID'])

        # Adding unique constraint on 'Image', fields ['UID']
        db.create_unique(u'dcmupload_image', ['UID'])


    def backwards(self, orm):
        # Removing unique constraint on 'Image', fields ['UID']
        db.delete_unique(u'dcmupload_image', ['UID'])

        # Removing unique constraint on 'Series', fields ['UID']
        db.delete_unique(u'dcmupload_series', ['UID'])
