...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Study'
        db.create_table(u'uploader_study', (
        ...
        db.send_create_signal(u'uploader', ['Study'])

        # Adding model 'Series'
        db.create_table(u'uploader_series', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('dcm_study', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['uploader.Study'])),
        ...
        db.send_create_signal(u'uploader', ['Series'])

        # Adding model 'Image'
        db.create_table(u'uploader_image', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('dcm_series', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['uploader.Series'])),
            ('UID', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ...
        db.send_create_signal(u'uploader', ['Image'])


    def backwards(self, orm):
        # Deleting model 'Study'
        db.delete_table(u'uploader_study')

        # Deleting model 'Series'
        db.delete_table(u'uploader_series')

        # Deleting model 'Image'
        db.delete_table(u'uploader_image')
